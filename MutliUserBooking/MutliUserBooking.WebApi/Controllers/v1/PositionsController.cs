...
using MutliUserBooking.Application.Features.Positions.Commands.DeletePositionById;
using MutliUserBooking.Application.Features.Positions.Commands.UpdatePosition;
using MutliUserBooking.Application.Features.Positions.Queries.GetPositionById;
using MutliUserBooking.Application.Features.Positions.Queries.GetPositions;
using MutliUserBooking.WebApi.Extensions;
using System;
